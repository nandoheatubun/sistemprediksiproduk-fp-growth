                                ...
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                     ...
                                     <?php   }elseif ($this->session->userdata('level') =="admin") { ?>
                                            <h5 class="card-title">
                                        <a style="font-size: 12px;" href="<?php echo base_url('Barang/tambahbarangmasuk'); ?>" class="btn btn-primary btn-sm"><i class="fas fa-plus"></i> Data Barang</a> 
                                        <!-- ||
                                        <a style="font-size: 12px;" href="<?php echo base_url('barang/ib'); ?>" class="btn btn-warning btn-sm"><i class="fas fa-plus"></i> Import Data Barang</a> -->
                                        </h5>
                                       <?php  } ?>
                                     ...
                                     <?php   }elseif ($this->session->userdata('level') =="admin") { ?>
                                       ...
                                       <?php  } ?>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center; font-size: 12px;"><?php echo substr($r->tanggal_masuk, 0,10); ?></td>
                                                 <?php if ($this->session->userdata('level') !="admin") { ?>
                                     <?php   }elseif ($this->session->userdata('level') =="admin") { ?>
                                        <td   style="text-align: center; font-size: 12px;">
                                                    <a href="<?php echo base_url('Barang/editbarangmasuk/'.$r->kode_barang); ?>"><i class="fa fa-pen" title="Edit Data Barang "></i></a> |
                                                <a onclick="return confirm('apakah anda ingin menghapus data ?')" href="<?php echo base_url('Barang/hapusbarangmasuk/'.$r->kode_barang); ?>"><i class="fa fa-trash" title="Hapus Data Barang "></i></a> 
                                                </td>
                                       <?php  } ?>
                                            </tr>
                                            <?php $i++; } ?>
